...
[![Release](https://img.shields.io/badge/Release-v1.7.0-5B8CFF)](#-下载与安装)
...
前往 [**Releases**](../../releases) 页面下载对应版本（当前 **v1.7.0**）：

| 版本 | 文件 | 适合人群 |
|---|---|---|
| **免安装便携版** | `DLSSG_Manager_1.7.0_portable_x64.zip` | 想即解压即用、绿色不写注册表 |
| **标准安装版** | `DLSSG_Manager_1.7.0_setup_x64.exe` | 想要安装向导、开始菜单/桌面快捷方式与完整卸载 |
